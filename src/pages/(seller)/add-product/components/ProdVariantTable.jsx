...
const ProdVariantTable = () => {
  ...
  // const generateVariantOptionsTable = React.useCallback(() => {
  ...
  // }, [variants, appendVariantOption]);

  // React.useEffect(() => {
  //   generateVariantOptionsTable();
  // }, [generateVariantOptionsTable, variants, primaryVariantType]);
